...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  TextFormField buildPriceField() {
    return TextFormField(
      initialValue: _editedProduct.price.toStringAsFixed(3),
      decoration: const InputDecoration(labelText: 'Giá'),
      textInputAction: TextInputAction.next,
  ...
  TextFormField buildDescriptionField() {
    return TextFormField(
      ...
      decoration: const InputDecoration(labelText: 'Mô tả'),
      maxLines: 3,
    ...
    return TextFormField(
      ...
      validator: (value) {
        ...
        if (!_isValidImageUrl(value)) {
          return 'Vui lòng nhập một URL hình ảnh hợp lệ.';
        }
        return null;
      },
      onSaved: (value) {
  ...
  Future<void> showErrorDialog(BuildContext context, String message) {
    return showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: const Text('Đã xảy ra lỗi'),
